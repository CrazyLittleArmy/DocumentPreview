...
java -Dsun.java2d.cmm=sun.java2d.cmm.kcms.KcmsServiceProvider -Dspring.config.location=..\conf\application.properties -jar DocumentPreview-2.1.2.jar -> ..\log\DocumentPreview.log